...
func displayTotalAmmoInMag(totalAmmoInMag : int, nbProjShotsAtSameTime : int):
	totalAmmoInMagLabelText.set_text(str(int(float(totalAmmoInMag) / float(nbProjShotsAtSameTime))))
	
func displayTotalAmmo(totalAmmo : int, nbProjShotsAtSameTime : int):
	totalAmmoLabelText.set_text(str(int(float(totalAmmo) / float(nbProjShotsAtSameTime))))
